    ...
    >
      ...
      <div class="flex items-end justify-between mt-1">
        <div>
          ...
          <h4 class="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">678</h4>
        </div>
      ...
      <div class="flex items-end justify-between mt-1">
        <div>
          <span class="text-sm text-gray-500 dark:text-gray-400">Riders</span>
          <h4 class="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">47</h4>
        </div>
    ...
    >
      ...
      <div class="flex items-end justify-between mt-1">
        <div>
          ...
          <h4 class="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">25,000</h4>
        </div>
